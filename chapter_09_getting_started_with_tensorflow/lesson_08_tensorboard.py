...
"""Example of using Tensorboard; remember to include timestamp in the log
directory name.
"""
...
# TENSORBOARD CODE:
# Create unique name per logdir by appending timestamp
...
# Creates a FileWriter used to write summaries to logfiles in the log directory.
